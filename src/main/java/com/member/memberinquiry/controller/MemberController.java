...
public class MemberController {
    ...
    public ResponseEntity<Member> updateMember(@PathVariable(name = "id") Long id,
    ...
    @GetMapping("/members")
    public ResponseEntity<PagingDTO<List<Member>>> getMembers(@RequestParam(name = "page", defaultValue = "1") int page,
    ...
    public ResponseEntity<String> deleteMember(@PathVariable(name = "id") Long id, HttpServletRequest request) {
